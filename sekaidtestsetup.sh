...
tsukid add-genesis-account $(tsukid keys show validator -a --keyring-backend=test --home=$HOME/.tsukid) 1000000000ukex,1000000000validatortoken,1000000000stake  --home=$HOME/.tsukid
