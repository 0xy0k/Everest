...
cat $HOME/.tsukid/config/genesis.json | jq '.app_state["customgov"]["network_properties"]["proposal_end_time"]="30"' > $HOME/.tsukid/config/tmp_genesis.json && mv $HOME/.tsukid/config/tmp_genesis.json $HOME/.tsukid/config/genesis.json
