...
func init() {
	...
	proto.RegisterType((*QueryDelegationsRequest)(nil), "tsuki.multistaking.QueryDelegationsRequest")
	proto.RegisterType((*QueryDelegationsResponse)(nil), "tsuki.multistaking.QueryDelegationsResponse")
...
func (c *queryClient) Delegations(ctx context.Context, in *QueryDelegationsRequest, opts ...grpc.CallOption) (*QueryDelegationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.multistaking.Query/Delegations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Delegations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.multistaking.Query/Delegations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
