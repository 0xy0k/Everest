...
// source: tsuki/basket/basket.proto
...
func init() {
	proto.RegisterType((*Basket)(nil), "tsuki.basket.Basket")
	proto.RegisterType((*BasketToken)(nil), "tsuki.basket.BasketToken")
	proto.RegisterType((*AmountAtTime)(nil), "tsuki.basket.AmountAtTime")
	proto.RegisterType((*Params)(nil), "tsuki.basket.Params")
}

func init() { proto.RegisterFile("tsuki/basket/basket.proto", fileDescriptor_8dee9a37d60b8713) }
