...
// source: tsuki/basket/query.proto
...
func init() {
	proto.RegisterType((*QueryTokenBasketByIdRequest)(nil), "tsuki.basket.QueryTokenBasketByIdRequest")
	proto.RegisterType((*QueryTokenBasketByIdResponse)(nil), "tsuki.basket.QueryTokenBasketByIdResponse")
	proto.RegisterType((*QueryTokenBasketByDenomRequest)(nil), "tsuki.basket.QueryTokenBasketByDenomRequest")
	proto.RegisterType((*QueryTokenBasketByDenomResponse)(nil), "tsuki.basket.QueryTokenBasketByDenomResponse")
	proto.RegisterType((*QueryTokenBasketsRequest)(nil), "tsuki.basket.QueryTokenBasketsRequest")
	proto.RegisterType((*QueryTokenBasketsResponse)(nil), "tsuki.basket.QueryTokenBasketsResponse")
	proto.RegisterType((*QueryBasketHistoricalMintsRequest)(nil), "tsuki.basket.QueryBasketHistoricalMintsRequest")
	proto.RegisterType((*QueryBasketHistoricalMintsResponse)(nil), "tsuki.basket.QueryBasketHistoricalMintsResponse")
	proto.RegisterType((*QueryBasketHistoricalBurnsRequest)(nil), "tsuki.basket.QueryBasketHistoricalBurnsRequest")
	proto.RegisterType((*QueryBasketHistoricalBurnsResponse)(nil), "tsuki.basket.QueryBasketHistoricalBurnsResponse")
	proto.RegisterType((*QueryBasketHistoricalSwapsRequest)(nil), "tsuki.basket.QueryBasketHistoricalSwapsRequest")
	proto.RegisterType((*QueryBasketHistoricalSwapsResponse)(nil), "tsuki.basket.QueryBasketHistoricalSwapsResponse")
}

func init() { proto.RegisterFile("tsuki/basket/query.proto", fileDescriptor_42506911a94aa353) }
...
func (c *queryClient) TokenBasketById(ctx context.Context, in *QueryTokenBasketByIdRequest, opts ...grpc.CallOption) (*QueryTokenBasketByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.basket.Query/TokenBasketById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenBasketByDenom(ctx context.Context, in *QueryTokenBasketByDenomRequest, opts ...grpc.CallOption) (*QueryTokenBasketByDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.basket.Query/TokenBasketByDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenBaskets(ctx context.Context, in *QueryTokenBasketsRequest, opts ...grpc.CallOption) (*QueryTokenBasketsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.basket.Query/TokenBaskets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) BaksetHistoricalMints(ctx context.Context, in *QueryBasketHistoricalMintsRequest, opts ...grpc.CallOption) (*QueryBasketHistoricalMintsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.basket.Query/BaksetHistoricalMints", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) BaksetHistoricalBurns(ctx context.Context, in *QueryBasketHistoricalBurnsRequest, opts ...grpc.CallOption) (*QueryBasketHistoricalBurnsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.basket.Query/BaksetHistoricalBurns", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) BaksetHistoricalSwaps(ctx context.Context, in *QueryBasketHistoricalSwapsRequest, opts ...grpc.CallOption) (*QueryBasketHistoricalSwapsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.basket.Query/BaksetHistoricalSwaps", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_TokenBasketById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.basket.Query/TokenBasketById",
	}
...
func _Query_TokenBasketByDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.basket.Query/TokenBasketByDenom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TokenBaskets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.basket.Query/TokenBaskets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_BaksetHistoricalMints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.basket.Query/BaksetHistoricalMints",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_BaksetHistoricalBurns_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.basket.Query/BaksetHistoricalBurns",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_BaksetHistoricalSwaps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.basket.Query/BaksetHistoricalSwaps",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.basket.Query",
	...
	Metadata: "tsuki/basket/query.proto",
}
