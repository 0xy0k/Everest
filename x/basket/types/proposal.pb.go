...
// source: tsuki/basket/proposal.proto
...
func init() {
	proto.RegisterType((*ProposalCreateBasket)(nil), "tsuki.basket.ProposalCreateBasket")
	proto.RegisterType((*ProposalEditBasket)(nil), "tsuki.basket.ProposalEditBasket")
	proto.RegisterType((*ProposalBasketWithdrawSurplus)(nil), "tsuki.basket.ProposalBasketWithdrawSurplus")
}

func init() { proto.RegisterFile("tsuki/basket/proposal.proto", fileDescriptor_5cb09524a833b7d6) }
