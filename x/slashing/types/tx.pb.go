...
// source: tsuki/slashing/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgActivate)(nil), "tsuki.slashing.MsgActivate")
	proto.RegisterType((*MsgActivateResponse)(nil), "tsuki.slashing.MsgActivateResponse")
	proto.RegisterType((*MsgPause)(nil), "tsuki.slashing.MsgPause")
	proto.RegisterType((*MsgPauseResponse)(nil), "tsuki.slashing.MsgPauseResponse")
	proto.RegisterType((*MsgUnpause)(nil), "tsuki.slashing.MsgUnpause")
	proto.RegisterType((*MsgUnpauseResponse)(nil), "tsuki.slashing.MsgUnpauseResponse")
	proto.RegisterType((*MsgRefuteSlashingProposal)(nil), "tsuki.slashing.MsgRefuteSlashingProposal")
	proto.RegisterType((*MsgRefuteSlashingProposalResponse)(nil), "tsuki.slashing.MsgRefuteSlashingProposalResponse")
	proto.RegisterType((*MsgSlashProposalVote)(nil), "tsuki.slashing.MsgSlashProposalVote")
	proto.RegisterType((*MsgSlashProposalVoteResponse)(nil), "tsuki.slashing.MsgSlashProposalVoteResponse")
}

func init() { proto.RegisterFile("tsuki/slashing/v1beta1/tx.proto", fileDescriptor_195ed35d11349041) }
...
func (c *msgClient) Activate(ctx context.Context, in *MsgActivate, opts ...grpc.CallOption) (*MsgActivateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.slashing.Msg/Activate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Pause(ctx context.Context, in *MsgPause, opts ...grpc.CallOption) (*MsgPauseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.slashing.Msg/Pause", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Unpause(ctx context.Context, in *MsgUnpause, opts ...grpc.CallOption) (*MsgUnpauseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.slashing.Msg/Unpause", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RefuteSlashingProposal(ctx context.Context, in *MsgRefuteSlashingProposal, opts ...grpc.CallOption) (*MsgRefuteSlashingProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.slashing.Msg/RefuteSlashingProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SlashProposalVote(ctx context.Context, in *MsgSlashProposalVote, opts ...grpc.CallOption) (*MsgSlashProposalVoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.slashing.Msg/SlashProposalVote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Activate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.slashing.Msg/Activate",
	}
...
func _Msg_Pause_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.slashing.Msg/Pause",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_Unpause_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.slashing.Msg/Unpause",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RefuteSlashingProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.slashing.Msg/RefuteSlashingProposal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SlashProposalVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.slashing.Msg/SlashProposalVote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.slashing.Msg",
	...
	Metadata: "tsuki/slashing/v1beta1/tx.proto",
}
