...
func init() {
	proto.RegisterType((*MsgProposalSoftwareUpgradeRequest)(nil), "tsuki.upgrade.MsgProposalSoftwareUpgradeRequest")
	proto.RegisterType((*MsgProposalSoftwareUpgradeResponse)(nil), "tsuki.upgrade.MsgProposalSoftwareUpgradeResponse")
	proto.RegisterType((*MsgProposalCancelSoftwareUpgradeRequest)(nil), "tsuki.upgrade.MsgProposalCancelSoftwareUpgradeRequest")
	proto.RegisterType((*MsgProposalCancelSoftwareUpgradeResponse)(nil), "tsuki.upgrade.MsgProposalCancelSoftwareUpgradeResponse")
}
...
func (c *msgClient) ProposalSoftwareUpgrade(ctx context.Context, in *MsgProposalSoftwareUpgradeRequest, opts ...grpc.CallOption) (*MsgProposalSoftwareUpgradeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.upgrade.Msg/ProposalSoftwareUpgrade", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ProposalCancelSoftwareUpgrade(ctx context.Context, in *MsgProposalCancelSoftwareUpgradeRequest, opts ...grpc.CallOption) (*MsgProposalCancelSoftwareUpgradeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.upgrade.Msg/ProposalCancelSoftwareUpgrade", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_ProposalSoftwareUpgrade_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.upgrade.Msg/ProposalSoftwareUpgrade",
	}
...
func _Msg_ProposalCancelSoftwareUpgrade_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.upgrade.Msg/ProposalCancelSoftwareUpgrade",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
