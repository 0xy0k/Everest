...
// source: tsuki/upgrade/query.proto
...
func init() {
	proto.RegisterType((*QueryCurrentPlanRequest)(nil), "tsuki.upgrade.QueryCurrentPlanRequest")
	proto.RegisterType((*QueryCurrentPlanResponse)(nil), "tsuki.upgrade.QueryCurrentPlanResponse")
	proto.RegisterType((*QueryNextPlanRequest)(nil), "tsuki.upgrade.QueryNextPlanRequest")
	proto.RegisterType((*QueryNextPlanResponse)(nil), "tsuki.upgrade.QueryNextPlanResponse")
}

func init() { proto.RegisterFile("tsuki/upgrade/query.proto", fileDescriptor_4d6e2e2517e583f0) }
...
func (c *queryClient) CurrentPlan(ctx context.Context, in *QueryCurrentPlanRequest, opts ...grpc.CallOption) (*QueryCurrentPlanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.upgrade.Query/CurrentPlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) NextPlan(ctx context.Context, in *QueryNextPlanRequest, opts ...grpc.CallOption) (*QueryNextPlanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.upgrade.Query/NextPlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_CurrentPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.upgrade.Query/CurrentPlan",
	}
...
func _Query_NextPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.upgrade.Query/NextPlan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.upgrade.Query",
	...
	Metadata: "tsuki/upgrade/query.proto",
}
