...
// source: tsuki/upgrade/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisStateV03123)(nil), "tsuki.upgrade.GenesisStateV03123")
}

func init() { proto.RegisterFile("tsuki/upgrade/genesis.proto", fileDescriptor_af8e84a023ffb915) }
