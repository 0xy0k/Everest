...
func TestItUpdatesTheValidatorSetBasedOnPendingValidators(t *testing.T) {
	...
	pubKey, err := sdk.GetPubKeyFromBech32(sdk.Bech32PubKeyTypeConsPub, "tsukivalconspub1zcjduepqylc5k8r40azmw0xt7hjugr4mr5w2am7jw77ux5w6s8hpjxyrjjsq4xg7em")
...
func TestItRemovesFromTheValidatorSetWhenInRemovingQueue(t *testing.T) {
	tests := []struct {
		name        string
		prepareFunc func(app *simapp.TsukiApp, ctx sdk.Context, validator stakingtypes.Validator)
	}{
		{
...
func TestItIncludesItBackToValidatorSetOnceReactivatingIt(t *testing.T) {
	tests := []struct {
		name                string
		prepareDeactivation func(app *simapp.TsukiApp, ctx sdk.Context, validator stakingtypes.Validator)
		prepareFunc         func(app *simapp.TsukiApp, ctx sdk.Context, validator stakingtypes.Validator)
	}{
		{
