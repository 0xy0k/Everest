...
func TestItRemovesFromTheValidatorSetWhenInRemovingQueue(t *testing.T) {
	tests := []struct {
		name        string
		prepareFunc func(app *simapp.TsukiApp, ctx types.Context, validator stakingtypes.Validator)
	}{
		{
...
func TestItIncludesItBackToValidatorSetOnceReactivatingIt(t *testing.T) {
	tests := []struct {
		name                string
		prepareDeactivation func(app *simapp.TsukiApp, ctx types.Context, validator stakingtypes.Validator)
		prepareFunc         func(app *simapp.TsukiApp, ctx types.Context, validator stakingtypes.Validator)
	}{
		{
