...
type MsgClaimValidator struct {
	...
	Commission *github_com_TsukiCore_cosmos_sdk_types.Dec       `protobuf:"bytes,5,opt,name=commission,proto3,customtype=github.com/TsukiCore/cosmos-sdk/types.Dec" json:"commission,omitempty" yaml:"commission"`
...
func (m *MsgClaimValidator) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			var v github_com_TsukiCore_cosmos_sdk_types.Dec
			m.Commission = &v
