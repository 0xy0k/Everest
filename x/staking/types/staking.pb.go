...
import (
	bytes "bytes"
	fmt "fmt"
	github_com_TsukiCore_cosmos_sdk_types "github.com/TsukiCore/cosmos-sdk/types"
...
type MsgClaimValidator struct {
	...
	Commission github_com_TsukiCore_cosmos_sdk_types.Dec        `protobuf:"bytes,5,opt,name=commission,proto3,customtype=github.com/TsukiCore/cosmos-sdk/types.Dec" json:"commission" yaml:"commission"`
	ValKey     github_com_TsukiCore_cosmos_sdk_types.ValAddress `protobuf:"bytes,6,opt,name=val_key,json=valKey,proto3,casttype=github.com/TsukiCore/cosmos-sdk/types.ValAddress" json:"val_key,omitempty" yaml:"val_key"`
	PubKey     github_com_TsukiCore_cosmos_sdk_types.AccAddress `protobuf:"bytes,7,opt,name=pub_key,json=pubKey,proto3,casttype=github.com/TsukiCore/cosmos-sdk/types.AccAddress" json:"pub_key,omitempty" yaml:"pub_key"`
}
...
func (m *MsgClaimValidator) GetValKey() github_com_TsukiCore_cosmos_sdk_types.ValAddress {
	if m != nil {
		return m.ValKey
	}
	return nil
...
func (m *MsgClaimValidator) GetPubKey() github_com_TsukiCore_cosmos_sdk_types.AccAddress {
	if m != nil {
		return m.PubKey
	}
	return nil
...
func (m *Validator) GetValKey() github_com_TsukiCore_cosmos_sdk_types.ValAddress {
	if m != nil {
		return m.ValKey
	}
	return nil
...
func (m *Validator) GetPubKey() github_com_TsukiCore_cosmos_sdk_types.AccAddress {
	if m != nil {
		return m.PubKey
	}
	return nil
