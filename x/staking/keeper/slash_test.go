...
func TestPauseValidator_Errors(t *testing.T) {
	tests := []struct {
		name            string
		expectedError   error
		prepareScenario func(app *simapp.TsukiApp, ctx sdk.Context, validator types.Validator)
	}{
		{
...
func TestReactivatingValidator(t *testing.T) {
	tests := []struct {
		name                string
		prepareDeactivation func(app *simapp.TsukiApp, ctx sdk.Context, validator types.Validator)
		prepare             func(app *simapp.TsukiApp, ctx sdk.Context, validator types.Validator)
	}{
		{
