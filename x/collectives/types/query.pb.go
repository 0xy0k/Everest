...
// source: tsuki/collectives/query.proto
...
import (
	context "context"
	fmt "fmt"
	types "github.com/TsukiCore/tsuki/x/gov/types"
...
func init() {
	proto.RegisterType((*CollectiveRequest)(nil), "tsuki.collectives.CollectiveRequest")
	proto.RegisterType((*CollectiveResponse)(nil), "tsuki.collectives.CollectiveResponse")
	proto.RegisterType((*CollectivesRequest)(nil), "tsuki.collectives.CollectivesRequest")
	proto.RegisterType((*CollectivesResponse)(nil), "tsuki.collectives.CollectivesResponse")
	proto.RegisterType((*CollectivesProposalsRequest)(nil), "tsuki.collectives.CollectivesProposalsRequest")
	proto.RegisterType((*CollectivesProposalsResponse)(nil), "tsuki.collectives.CollectivesProposalsResponse")
	proto.RegisterType((*CollectivesByAccountRequest)(nil), "tsuki.collectives.CollectivesByAccountRequest")
	proto.RegisterType((*CollectivesByAccountResponse)(nil), "tsuki.collectives.CollectivesByAccountResponse")
}

func init() { proto.RegisterFile("tsuki/collectives/query.proto", fileDescriptor_b68644cb3cfae16f) }
...
func (c *queryClient) Collective(ctx context.Context, in *CollectiveRequest, opts ...grpc.CallOption) (*CollectiveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.collectives.Query/Collective", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Collectives(ctx context.Context, in *CollectivesRequest, opts ...grpc.CallOption) (*CollectivesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.collectives.Query/Collectives", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CollectivesProposals(ctx context.Context, in *CollectivesProposalsRequest, opts ...grpc.CallOption) (*CollectivesProposalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.collectives.Query/CollectivesProposals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CollectivesByAccount(ctx context.Context, in *CollectivesByAccountRequest, opts ...grpc.CallOption) (*CollectivesByAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.collectives.Query/CollectivesByAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Collective_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.collectives.Query/Collective",
	}
...
func _Query_Collectives_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.collectives.Query/Collectives",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_CollectivesProposals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.collectives.Query/CollectivesProposals",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_CollectivesByAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.collectives.Query/CollectivesByAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.collectives.Query",
	...
	Metadata: "tsuki/collectives/query.proto",
}
