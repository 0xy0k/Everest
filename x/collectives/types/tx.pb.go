...
// source: tsuki/collectives/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateCollective)(nil), "tsuki.collectives.MsgCreateCollective")
	proto.RegisterType((*MsgCreateCollectiveResponse)(nil), "tsuki.collectives.MsgCreateCollectiveResponse")
	proto.RegisterType((*MsgBondCollective)(nil), "tsuki.collectives.MsgBondCollective")
	proto.RegisterType((*MsgBondCollectiveResponse)(nil), "tsuki.collectives.MsgBondCollectiveResponse")
	proto.RegisterType((*MsgDonateCollective)(nil), "tsuki.collectives.MsgDonateCollective")
	proto.RegisterType((*MsgDonateCollectiveResponse)(nil), "tsuki.collectives.MsgDonateCollectiveResponse")
	proto.RegisterType((*MsgWithdrawCollective)(nil), "tsuki.collectives.MsgWithdrawCollective")
	proto.RegisterType((*MsgWithdrawCollectiveResponse)(nil), "tsuki.collectives.MsgWithdrawCollectiveResponse")
}

func init() { proto.RegisterFile("tsuki/collectives/tx.proto", fileDescriptor_0cc3032dd5313583) }
...
func (c *msgClient) CreateCollective(ctx context.Context, in *MsgCreateCollective, opts ...grpc.CallOption) (*MsgCreateCollectiveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.collectives.Msg/CreateCollective", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ContributeCollective(ctx context.Context, in *MsgBondCollective, opts ...grpc.CallOption) (*MsgBondCollectiveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.collectives.Msg/ContributeCollective", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DonateCollective(ctx context.Context, in *MsgDonateCollective, opts ...grpc.CallOption) (*MsgDonateCollectiveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.collectives.Msg/DonateCollective", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawCollective(ctx context.Context, in *MsgWithdrawCollective, opts ...grpc.CallOption) (*MsgWithdrawCollectiveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.collectives.Msg/WithdrawCollective", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateCollective_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.collectives.Msg/CreateCollective",
	}
...
func _Msg_ContributeCollective_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.collectives.Msg/ContributeCollective",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DonateCollective_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.collectives.Msg/DonateCollective",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_WithdrawCollective_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.collectives.Msg/WithdrawCollective",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.collectives.Msg",
	...
	Metadata: "tsuki/collectives/tx.proto",
}
