...
// source: tsuki/spending/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateSpendingPool)(nil), "tsuki.spending.MsgCreateSpendingPool")
	proto.RegisterType((*MsgCreateSpendingPoolResponse)(nil), "tsuki.spending.MsgCreateSpendingPoolResponse")
	proto.RegisterType((*MsgDepositSpendingPool)(nil), "tsuki.spending.MsgDepositSpendingPool")
	proto.RegisterType((*MsgDepositSpendingPoolResponse)(nil), "tsuki.spending.MsgDepositSpendingPoolResponse")
	proto.RegisterType((*MsgRegisterSpendingPoolBeneficiary)(nil), "tsuki.spending.MsgRegisterSpendingPoolBeneficiary")
	proto.RegisterType((*MsgRegisterSpendingPoolBeneficiaryResponse)(nil), "tsuki.spending.MsgRegisterSpendingPoolBeneficiaryResponse")
	proto.RegisterType((*MsgClaimSpendingPool)(nil), "tsuki.spending.MsgClaimSpendingPool")
	proto.RegisterType((*MsgClaimSpendingPoolResponse)(nil), "tsuki.spending.MsgClaimSpendingPoolResponse")
}

func init() { proto.RegisterFile("tsuki/spending/tx.proto", fileDescriptor_edfb840607cf4f3d) }
...
func (c *msgClient) CreateSpendingPool(ctx context.Context, in *MsgCreateSpendingPool, opts ...grpc.CallOption) (*MsgCreateSpendingPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.spending.Msg/CreateSpendingPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DepositSpendingPool(ctx context.Context, in *MsgDepositSpendingPool, opts ...grpc.CallOption) (*MsgDepositSpendingPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.spending.Msg/DepositSpendingPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RegisterSpendingPoolBeneficiary(ctx context.Context, in *MsgRegisterSpendingPoolBeneficiary, opts ...grpc.CallOption) (*MsgRegisterSpendingPoolBeneficiaryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.spending.Msg/RegisterSpendingPoolBeneficiary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimSpendingPool(ctx context.Context, in *MsgClaimSpendingPool, opts ...grpc.CallOption) (*MsgClaimSpendingPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.spending.Msg/ClaimSpendingPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateSpendingPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.spending.Msg/CreateSpendingPool",
	}
...
func _Msg_DepositSpendingPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.spending.Msg/DepositSpendingPool",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RegisterSpendingPoolBeneficiary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.spending.Msg/RegisterSpendingPoolBeneficiary",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ClaimSpendingPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.spending.Msg/ClaimSpendingPool",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.spending.Msg",
	...
	Metadata: "tsuki/spending/tx.proto",
}
