...
// source: tsuki/spending/query.proto
...
func init() {
	proto.RegisterType((*QueryPoolNamesRequest)(nil), "tsuki.spending.QueryPoolNamesRequest")
	proto.RegisterType((*QueryPoolNamesResponse)(nil), "tsuki.spending.QueryPoolNamesResponse")
	proto.RegisterType((*QueryPoolByNameRequest)(nil), "tsuki.spending.QueryPoolByNameRequest")
	proto.RegisterType((*QueryPoolByNameResponse)(nil), "tsuki.spending.QueryPoolByNameResponse")
	proto.RegisterType((*QueryPoolProposalsRequest)(nil), "tsuki.spending.QueryPoolProposalsRequest")
	proto.RegisterType((*QueryPoolProposalsResponse)(nil), "tsuki.spending.QueryPoolProposalsResponse")
	proto.RegisterType((*QueryPoolsByAccountRequest)(nil), "tsuki.spending.QueryPoolsByAccountRequest")
	proto.RegisterType((*QueryPoolsByAccountResponse)(nil), "tsuki.spending.QueryPoolsByAccountResponse")
}

func init() { proto.RegisterFile("tsuki/spending/query.proto", fileDescriptor_9a9e7ad8ce361859) }
...
func (c *queryClient) QueryPoolNames(ctx context.Context, in *QueryPoolNamesRequest, opts ...grpc.CallOption) (*QueryPoolNamesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.spending.Query/QueryPoolNames", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryPoolByName(ctx context.Context, in *QueryPoolByNameRequest, opts ...grpc.CallOption) (*QueryPoolByNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.spending.Query/QueryPoolByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryPoolProposals(ctx context.Context, in *QueryPoolProposalsRequest, opts ...grpc.CallOption) (*QueryPoolProposalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.spending.Query/QueryPoolProposals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryPoolsByAccount(ctx context.Context, in *QueryPoolsByAccountRequest, opts ...grpc.CallOption) (*QueryPoolsByAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.spending.Query/QueryPoolsByAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_QueryPoolNames_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.spending.Query/QueryPoolNames",
	}
...
func _Query_QueryPoolByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.spending.Query/QueryPoolByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_QueryPoolProposals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.spending.Query/QueryPoolProposals",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_QueryPoolsByAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.spending.Query/QueryPoolsByAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.spending.Query",
	...
	Metadata: "tsuki/spending/query.proto",
}
