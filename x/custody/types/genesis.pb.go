...
// source: tsuki/custody/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "tsuki.custody.GenesisState")
}

func init() { proto.RegisterFile("tsuki/custody/genesis.proto", fileDescriptor_42aaa914cab7e6e1) }
