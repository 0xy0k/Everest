...
func init() {
	...
	proto.RegisterType((*MsgAddToCustodyLimitsStatus)(nil), "tsuki.custody.MsgAddToCustodyLimitsStatus")
	...
	proto.RegisterType((*MsgAddToCustodyPool)(nil), "tsuki.custody.MsgAddToCustodyPool")
	proto.RegisterType((*MsgRemoveFromCustodyPool)(nil), "tsuki.custody.MsgRemoveFromCustodyPool")
	proto.RegisterType((*MsgCreteCustodyRecordResponse)(nil), "tsuki.custody.MsgCreteCustodyRecordResponse")
	proto.RegisterType((*MsgAddToCustodyPoolResponse)(nil), "tsuki.custody.MsgAddToCustodyPoolResponse")
	proto.RegisterType((*MsgRemoveFromCustodyPoolResponse)(nil), "tsuki.custody.MsgRemoveFromCustodyPoolResponse")
	...
	proto.RegisterType((*MsgAddToCustodyLimitsStatusResponse)(nil), "tsuki.custody.MsgAddToCustodyLimitsStatusResponse")
...
func (c *msgClient) AddToCustodyPool(ctx context.Context, in *MsgAddToCustodyPool, opts ...grpc.CallOption) (*MsgAddToCustodyPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.custody.Msg/AddToCustodyPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RemoveFromCustodyPool(ctx context.Context, in *MsgRemoveFromCustodyPool, opts ...grpc.CallOption) (*MsgRemoveFromCustodyPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.custody.Msg/RemoveFromCustodyPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AddToLimitsStatus(ctx context.Context, in *MsgAddToCustodyLimitsStatus, opts ...grpc.CallOption) (*MsgAddToCustodyLimitsStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.custody.Msg/AddToLimitsStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddToCustodyPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.custody.Msg/AddToCustodyPool",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RemoveFromCustodyPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.custody.Msg/RemoveFromCustodyPool",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_AddToLimitsStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.custody.Msg/AddToLimitsStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
