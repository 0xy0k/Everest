...
import (
	context "context"
	fmt "fmt"
	_ "github.com/TsukiCore/tsuki/x/gov/types"
...
func init() {
	proto.RegisterType((*QueryUBIRecordsRequest)(nil), "tsuki.ubi.QueryUBIRecordsRequest")
	proto.RegisterType((*QueryUBIRecordsResponse)(nil), "tsuki.ubi.QueryUBIRecordsResponse")
	proto.RegisterType((*QueryUBIRecordByNameRequest)(nil), "tsuki.ubi.QueryUBIRecordByNameRequest")
	proto.RegisterType((*QueryUBIRecordByNameResponse)(nil), "tsuki.ubi.QueryUBIRecordByNameResponse")
}

func init() { proto.RegisterFile("tsuki/ubi/query.proto", fileDescriptor_ce4683e7ea12df2a) }
...
func (c *queryClient) QueryUBIRecords(ctx context.Context, in *QueryUBIRecordsRequest, opts ...grpc.CallOption) (*QueryUBIRecordsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.ubi.Query/QueryUBIRecords", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryUBIRecordByName(ctx context.Context, in *QueryUBIRecordByNameRequest, opts ...grpc.CallOption) (*QueryUBIRecordByNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.ubi.Query/QueryUBIRecordByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_QueryUBIRecords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.ubi.Query/QueryUBIRecords",
	}
...
func _Query_QueryUBIRecordByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.ubi.Query/QueryUBIRecordByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "tsuki/ubi/query.proto",
}
