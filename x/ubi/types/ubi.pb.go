...
func init() {
	proto.RegisterType((*UBIRecord)(nil), "tsuki.ubi.UBIRecord")
}

func init() { proto.RegisterFile("tsuki/ubi/ubi.proto", fileDescriptor_27b7349fe391b1c8) }
