...
func (k Keeper) AllProposalDurations(goCtx context.Context, req *types.QueryAllProposalDurations) (*types.QueryAllProposalDurationsResponse, error) {
	...
	for _, pt := range tsukitypes.AllProposalTypes {
...
// QueryAddressesByWhitelistedPermission - list all TSUKI addresses by a specific whitelisted permission (address does NOT have to be a Councilor)
...
// QueryAddressesByBlacklistedPermission - list all TSUKI addresses by a specific whitelisted permission (address does NOT have to be a Councilor)
...
// QueryAddressesByWhitelistedRole - list all tsuki addresses by a specific whitelisted role (address does NOT have to be a Councilor)
...
// QueryAddressesByBlacklistedRole - list all tsuki addresses by a specific whitelisted role (address does NOT have to be a Councilor)
