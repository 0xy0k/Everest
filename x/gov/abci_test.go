...
func TestEndBlocker_ActiveProposal(t *testing.T) {
	tests := []struct {
		name              string
		prepareScenario   func(app *simapp.TsukiApp, ctx sdk.Context) []sdk.AccAddress
		validateScenario  func(t *testing.T, app *simapp.TsukiApp, ctx sdk.Context, addrs []sdk.AccAddress)
