...
func init() {
	...
	proto.RegisterType((*SetProposalDurationProposal)(nil), "tsuki.gov.SetProposalDurationProposal")
	proto.RegisterType((*SetBatchProposalDurationsProposal)(nil), "tsuki.gov.SetBatchProposalDurationsProposal")
}
