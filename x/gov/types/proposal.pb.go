...
type Proposal struct {
	...
	Result                     VoteResult `protobuf:"varint,10,opt,name=result,proto3,enum=tsuki.gov.VoteResult" json:"result,omitempty"`
...
type WhitelistAccountPermissionProposal struct {
	...
	Permission PermValue                                     `protobuf:"varint,2,opt,name=permission,proto3,enum=tsuki.gov.PermValue" json:"permission,omitempty"`
}
...
func init() {
	proto.RegisterEnum("tsuki.gov.VoteOption", VoteOption_name, VoteOption_value)
	proto.RegisterEnum("tsuki.gov.VoteResult", VoteResult_name, VoteResult_value)
	proto.RegisterType((*Vote)(nil), "tsuki.gov.Vote")
	proto.RegisterType((*MsgVoteProposal)(nil), "tsuki.gov.MsgVoteProposal")
	proto.RegisterType((*Proposal)(nil), "tsuki.gov.Proposal")
	proto.RegisterType((*WhitelistAccountPermissionProposal)(nil), "tsuki.gov.WhitelistAccountPermissionProposal")
	proto.RegisterType((*BlacklistAccountPermissionProposal)(nil), "tsuki.gov.BlacklistAccountPermissionProposal")
	proto.RegisterType((*RemoveWhitelistedAccountPermissionProposal)(nil), "tsuki.gov.RemoveWhitelistedAccountPermissionProposal")
	proto.RegisterType((*RemoveBlacklistedAccountPermissionProposal)(nil), "tsuki.gov.RemoveBlacklistedAccountPermissionProposal")
	proto.RegisterType((*AssignRoleToAccountProposal)(nil), "tsuki.gov.AssignRoleToAccountProposal")
	proto.RegisterType((*UnassignRoleFromAccountProposal)(nil), "tsuki.gov.UnassignRoleFromAccountProposal")
	proto.RegisterType((*WhitelistRolePermissionProposal)(nil), "tsuki.gov.WhitelistRolePermissionProposal")
	proto.RegisterType((*BlacklistRolePermissionProposal)(nil), "tsuki.gov.BlacklistRolePermissionProposal")
	proto.RegisterType((*RemoveWhitelistedRolePermissionProposal)(nil), "tsuki.gov.RemoveWhitelistedRolePermissionProposal")
	proto.RegisterType((*RemoveBlacklistedRolePermissionProposal)(nil), "tsuki.gov.RemoveBlacklistedRolePermissionProposal")
	proto.RegisterType((*SetNetworkPropertyProposal)(nil), "tsuki.gov.SetNetworkPropertyProposal")
	proto.RegisterType((*UpsertDataRegistryProposal)(nil), "tsuki.gov.UpsertDataRegistryProposal")
	proto.RegisterType((*SetPoorNetworkMessagesProposal)(nil), "tsuki.gov.SetPoorNetworkMessagesProposal")
	proto.RegisterType((*CreateRoleProposal)(nil), "tsuki.gov.CreateRoleProposal")
	proto.RegisterType((*RemoveRoleProposal)(nil), "tsuki.gov.RemoveRoleProposal")
	proto.RegisterType((*SetProposalDurationsProposal)(nil), "tsuki.gov.SetProposalDurationsProposal")
	proto.RegisterType((*ProposalResetWholeCouncilorRank)(nil), "tsuki.gov.ProposalResetWholeCouncilorRank")
	proto.RegisterType((*ProposalJailCouncilor)(nil), "tsuki.gov.ProposalJailCouncilor")
}

func init() { proto.RegisterFile("tsuki/gov/proposal.proto", fileDescriptor_e108f9b9b2d46b19) }
