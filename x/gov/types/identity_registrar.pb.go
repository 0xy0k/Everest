...
func init() {
	proto.RegisterType((*IdentityRecord)(nil), "tsuki.gov.IdentityRecord")
	proto.RegisterMapType((map[string]string)(nil), "tsuki.gov.IdentityRecord.InfosEntry")
	proto.RegisterType((*AddressIdentityRecord)(nil), "tsuki.gov.AddressIdentityRecord")
	proto.RegisterMapType((map[string]string)(nil), "tsuki.gov.AddressIdentityRecord.InfosEntry")
	proto.RegisterType((*VerifiedIdRecordByAddress)(nil), "tsuki.gov.VerifiedIdRecordByAddress")
	proto.RegisterType((*VerifiedIdRecordsByAddress)(nil), "tsuki.gov.VerifiedIdRecordsByAddress")
	proto.RegisterType((*MsgCreateIdentityRecord)(nil), "tsuki.gov.MsgCreateIdentityRecord")
	proto.RegisterMapType((map[string]string)(nil), "tsuki.gov.MsgCreateIdentityRecord.InfosEntry")
	proto.RegisterType((*IdentityRecordsVerify)(nil), "tsuki.gov.IdentityRecordsVerify")
	proto.RegisterType((*MsgRequestIdentityRecordsVerify)(nil), "tsuki.gov.MsgRequestIdentityRecordsVerify")
	proto.RegisterType((*MsgApproveIdentityRecords)(nil), "tsuki.gov.MsgApproveIdentityRecords")
}
