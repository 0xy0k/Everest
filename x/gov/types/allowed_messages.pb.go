...
// source: tsuki/gov/allowed_messages.proto
...
func init() {
	proto.RegisterType((*AllowedMessages)(nil), "tsuki.gov.AllowedMessages")
}

func init() { proto.RegisterFile("tsuki/gov/allowed_messages.proto", fileDescriptor_c40df6bae73197f9) }
