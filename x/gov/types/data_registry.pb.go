...
func init() {
	proto.RegisterType((*DataRegistryEntry)(nil), "tsuki.gov.DataRegistryEntry")
}

func init() { proto.RegisterFile("tsuki/gov/data_registry.proto", fileDescriptor_740f8fb5adb6d79b) }
