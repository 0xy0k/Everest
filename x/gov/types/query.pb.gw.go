...
var (
	...
	pattern_Query_IdentityRecords_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"tsuki", "gov", "identity_records", "creator"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_Query_IdentityRecordVerifyRequests_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"tsuki", "gov", "identity_verify_requests", "requester"}, "", runtime.AssumeColonVerbOpt(true)))
