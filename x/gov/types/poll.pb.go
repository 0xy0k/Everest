...
type PollVote struct {
	...
	Option      PollVoteOption                                `protobuf:"varint,3,opt,name=option,proto3,enum=tsuki.gov.PollVoteOption" json:"option,omitempty"`
...
type Poll struct {
	...
	Result        PollResult                                    `protobuf:"varint,10,opt,name=result,proto3,enum=tsuki.gov.PollResult" json:"result,omitempty"`
}
...
func init() {
	proto.RegisterEnum("tsuki.gov.PollVoteOption", PollVoteOption_name, PollVoteOption_value)
	proto.RegisterEnum("tsuki.gov.PollResult", PollResult_name, PollResult_value)
	proto.RegisterType((*PollVote)(nil), "tsuki.gov.PollVote")
	proto.RegisterType((*PollOptions)(nil), "tsuki.gov.PollOptions")
	proto.RegisterType((*AddressPolls)(nil), "tsuki.gov.AddressPolls")
	proto.RegisterType((*Poll)(nil), "tsuki.gov.Poll")
	proto.RegisterType((*MsgPollVote)(nil), "tsuki.gov.MsgPollVote")
	proto.RegisterType((*MsgPollCreate)(nil), "tsuki.gov.MsgPollCreate")
}

func init() { proto.RegisterFile("tsuki/gov/poll.proto", fileDescriptor_c3fa5d41f67be42c) }
