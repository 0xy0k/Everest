...
// source: tsuki/gov/genesis.proto
...
func init() {
	...
	proto.RegisterMapType((map[string]uint64)(nil), "tsuki.gov.GenesisState.ProposalDurationsEntry")
	proto.RegisterMapType((map[uint64]*Permissions)(nil), "tsuki.gov.GenesisState.RolePermissionsEntry")
}

func init() { proto.RegisterFile("tsuki/gov/genesis.proto", fileDescriptor_042721fb65a4ea2d) }
