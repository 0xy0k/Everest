...
func init() {
	...
	proto.RegisterType((*QueryAddressesByBlacklistedRole)(nil), "tsuki.gov.QueryAddressesByBlacklistedRole")
	proto.RegisterType((*QueryAddressesByBlacklistedRoleResponse)(nil), "tsuki.gov.QueryAddressesByBlacklistedRoleResponse")
}
...
func (c *queryClient) QueryAddressesByBlacklistedRole(ctx context.Context, in *QueryAddressesByBlacklistedRole, opts ...grpc.CallOption) (*QueryAddressesByBlacklistedRoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.gov.Query/QueryAddressesByBlacklistedRole", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_QueryAddressesByBlacklistedRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.gov.Query/QueryAddressesByBlacklistedRole",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
