...
func init() {
	...
	proto.RegisterType((*RolePermissionsRequest)(nil), "tsuki.gov.RolePermissionsRequest")
	proto.RegisterType((*RolePermissionsResponse)(nil), "tsuki.gov.RolePermissionsResponse")
...
func (c *queryClient) RolePermissions(ctx context.Context, in *RolePermissionsRequest, opts ...grpc.CallOption) (*RolePermissionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.gov.Query/RolePermissions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_RolePermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.gov.Query/RolePermissions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
