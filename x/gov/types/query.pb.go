...
func init() {
	...
	proto.RegisterType((*QueryIdentityRecordByAddressRequest)(nil), "tsuki.gov.QueryIdentityRecordByAddressRequest")
	proto.RegisterType((*QueryIdentityRecordByAddressResponse)(nil), "tsuki.gov.QueryIdentityRecordByAddressResponse")
...
func (c *queryClient) IdentityRecordByAddress(ctx context.Context, in *QueryIdentityRecordByAddressRequest, opts ...grpc.CallOption) (*QueryIdentityRecordByAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.gov.Query/IdentityRecordByAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_IdentityRecordByAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.gov.Query/IdentityRecordByAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
