...
// source: tsuki/gov/poll_proposal.proto
...
func init() {
	...
	proto.RegisterType((*PollProposal)(nil), "tsuki.gov.PollProposal")
	proto.RegisterType((*MsgPollVoteProposal)(nil), "tsuki.gov.MsgPollVoteProposal")
	proto.RegisterType((*MsgPollCreate)(nil), "tsuki.gov.MsgPollCreate")
}

func init() { proto.RegisterFile("tsuki/gov/poll_proposal.proto", fileDescriptor_880c66761dcb3b2a) }
