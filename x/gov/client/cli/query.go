...
Example:
$ %s query gov vote 1 tsuki1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`,
				version.AppName,
			),
		),
...
// ranks & abstenation counters - add sub-query to search by specific TSUKI address
...
// GetCmdQueryAddressesByWhitelistedPermission - list all TSUKI addresses by a specific whitelisted permission (address does NOT have to be a Councilor)
func GetCmdQueryAddressesByWhitelistedPermission() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "whitelisted-permission-addresses [perm]",
		Args:  cobra.ExactArgs(1),
		Short: "Query all TSUKI addresses by a specific whitelisted permission",
		Long: strings.TrimSpace(
			fmt.Sprintf(`Query all TSUKI addresses by a specific whitelisted permission.
...
// GetCmdQueryAddressesByBlacklistedPermission - list all TSUKI addresses by a specific blacklisted permission (address does NOT have to be a Councilor)
func GetCmdQueryAddressesByBlacklistedPermission() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "blacklisted-permission-addresses [perm]",
		Args:  cobra.ExactArgs(1),
		Short: "Query all TSUKI addresses by a specific blacklisted permission",
		Long: strings.TrimSpace(
			fmt.Sprintf(`Query all TSUKI addresses by a specific blacklisted permission.
...
// GetCmdQueryAddressesByWhitelistedRole - list all tsuki addresses by a specific whitelisted role (address does NOT have to be a Councilor)
func GetCmdQueryAddressesByWhitelistedRole() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "whitelisted-role-addresses [role]",
		Args:  cobra.ExactArgs(1),
		Short: "Query all tsuki addresses by a specific whitelisted role (address does NOT have to be a Councilor)",
		Long: strings.TrimSpace(
			fmt.Sprintf(`Query all tsuki addresses by a specific whitelisted role (address does NOT have to be a Councilor).
...
// GetCmdQueryAddressesByBlacklistedRole - list all tsuki addresses by a specific blacklisted role (address does NOT have to be a Councilor)
func GetCmdQueryAddressesByBlacklistedRole() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "blacklisted-role-addresses [role]",
		Args:  cobra.ExactArgs(1),
		Short: "Query all tsuki addresses by a specific blacklisted role (address does NOT have to be a Councilor)",
		Long: strings.TrimSpace(
			fmt.Sprintf(`Query all tsuki addresses by a specific blacklisted role (address does NOT have to be a Councilor).
