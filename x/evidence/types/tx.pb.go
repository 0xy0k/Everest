...
// source: tsuki/evidence/tx.proto
...
func init() {
	proto.RegisterType((*MsgSubmitEvidence)(nil), "tsuki.evidence.MsgSubmitEvidence")
	proto.RegisterType((*MsgSubmitEvidenceResponse)(nil), "tsuki.evidence.MsgSubmitEvidenceResponse")
}

func init() { proto.RegisterFile("tsuki/evidence/tx.proto", fileDescriptor_198fe1e2e4821e46) }
...
func (c *msgClient) SubmitEvidence(ctx context.Context, in *MsgSubmitEvidence, opts ...grpc.CallOption) (*MsgSubmitEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.evidence.Msg/SubmitEvidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitEvidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.evidence.Msg/SubmitEvidence",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.evidence.Msg",
	...
	Metadata: "tsuki/evidence/tx.proto",
}
