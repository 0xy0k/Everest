...
// source: tsuki/evidence/evidence.proto
...
func init() {
	proto.RegisterType((*Equivocation)(nil), "tsuki.evidence.Equivocation")
}

func init() { proto.RegisterFile("tsuki/evidence/evidence.proto", fileDescriptor_7261484274045646) }
