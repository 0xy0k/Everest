...
// source: tsuki/evidence/query.proto
...
func init() {
	proto.RegisterType((*QueryEvidenceRequest)(nil), "tsuki.evidence.QueryEvidenceRequest")
	proto.RegisterType((*QueryEvidenceResponse)(nil), "tsuki.evidence.QueryEvidenceResponse")
	proto.RegisterType((*QueryAllEvidenceRequest)(nil), "tsuki.evidence.QueryAllEvidenceRequest")
	proto.RegisterType((*QueryAllEvidenceResponse)(nil), "tsuki.evidence.QueryAllEvidenceResponse")
}

func init() { proto.RegisterFile("tsuki/evidence/query.proto", fileDescriptor_b0affbd5e02a9fc1) }
...
func (c *queryClient) Evidence(ctx context.Context, in *QueryEvidenceRequest, opts ...grpc.CallOption) (*QueryEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.evidence.Query/Evidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllEvidence(ctx context.Context, in *QueryAllEvidenceRequest, opts ...grpc.CallOption) (*QueryAllEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.evidence.Query/AllEvidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Evidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.evidence.Query/Evidence",
	}
...
func _Query_AllEvidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.evidence.Query/AllEvidence",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.evidence.Query",
	...
	Metadata: "tsuki/evidence/query.proto",
}
