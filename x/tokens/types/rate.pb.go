...
func init() {
	proto.RegisterType((*TokenRate)(nil), "tsuki.tokens.TokenRate")
	proto.RegisterType((*MsgUpsertTokenRate)(nil), "tsuki.tokens.MsgUpsertTokenRate")
}

func init() { proto.RegisterFile("tsuki/tokens/rate.proto", fileDescriptor_d415c64b17c96dda) }
