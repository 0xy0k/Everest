...
func init() {
	...
	proto.RegisterType((*MsgProposalUpsertTokenAliasResponse)(nil), "tsuki.tokens.MsgProposalUpsertTokenAliasResponse")
	proto.RegisterType((*MsgProposalUpsertTokenRatesResponse)(nil), "tsuki.tokens.MsgProposalUpsertTokenRatesResponse")
	proto.RegisterType((*MsgProposalTokensWhiteBlackChangeResponse)(nil), "tsuki.tokens.MsgProposalTokensWhiteBlackChangeResponse")
}
...
func (c *msgClient) ProposalUpsertTokenAlias(ctx context.Context, in *MsgProposalUpsertTokenAlias, opts ...grpc.CallOption) (*MsgProposalUpsertTokenAliasResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.tokens.Msg/ProposalUpsertTokenAlias", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ProposalUpsertTokenRates(ctx context.Context, in *MsgProposalUpsertTokenRates, opts ...grpc.CallOption) (*MsgProposalUpsertTokenRatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.tokens.Msg/ProposalUpsertTokenRates", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ProposalTokensWhiteBlackChange(ctx context.Context, in *MsgProposalTokensWhiteBlackChange, opts ...grpc.CallOption) (*MsgProposalTokensWhiteBlackChangeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.tokens.Msg/ProposalTokensWhiteBlackChange", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_ProposalUpsertTokenAlias_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.tokens.Msg/ProposalUpsertTokenAlias",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ProposalUpsertTokenRates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.tokens.Msg/ProposalUpsertTokenRates",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ProposalTokensWhiteBlackChange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.tokens.Msg/ProposalTokensWhiteBlackChange",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
