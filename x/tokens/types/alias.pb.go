...
type TokenAlias struct {
	...
	AllowedVoteTypes []VoteType     `protobuf:"varint,3,rep,packed,name=allowed_vote_types,json=allowedVoteTypes,proto3,enum=tsuki.tokens.VoteType" json:"allowed_vote_types,omitempty"`
	...
	Status           ProposalStatus `protobuf:"varint,9,opt,name=status,proto3,enum=tsuki.tokens.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("tsuki.tokens.VoteType", VoteType_name, VoteType_value)
	proto.RegisterEnum("tsuki.tokens.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*TokenAlias)(nil), "tsuki.tokens.TokenAlias")
	proto.RegisterType((*MsgUpsertTokenAlias)(nil), "tsuki.tokens.MsgUpsertTokenAlias")
}
