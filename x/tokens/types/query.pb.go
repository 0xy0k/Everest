...
func init() {
	proto.RegisterType((*TokenAliasRequest)(nil), "tsuki.tokens.TokenAliasRequest")
	proto.RegisterType((*TokenAliasResponse)(nil), "tsuki.tokens.TokenAliasResponse")
	proto.RegisterType((*AllTokenAliasesRequest)(nil), "tsuki.tokens.AllTokenAliasesRequest")
	proto.RegisterType((*AllTokenAliasesResponse)(nil), "tsuki.tokens.AllTokenAliasesResponse")
	proto.RegisterType((*TokenAliasesByDenomRequest)(nil), "tsuki.tokens.TokenAliasesByDenomRequest")
	proto.RegisterType((*TokenAliasesByDenomResponse)(nil), "tsuki.tokens.TokenAliasesByDenomResponse")
	proto.RegisterMapType((map[string]*TokenAlias)(nil), "tsuki.tokens.TokenAliasesByDenomResponse.DataEntry")
	proto.RegisterType((*TokenRateRequest)(nil), "tsuki.tokens.TokenRateRequest")
	proto.RegisterType((*TokenRateResponse)(nil), "tsuki.tokens.TokenRateResponse")
	proto.RegisterType((*AllTokenRatesRequest)(nil), "tsuki.tokens.AllTokenRatesRequest")
	proto.RegisterType((*AllTokenRatesResponse)(nil), "tsuki.tokens.AllTokenRatesResponse")
	proto.RegisterType((*TokenRatesByDenomRequest)(nil), "tsuki.tokens.TokenRatesByDenomRequest")
	proto.RegisterType((*TokenRatesByDenomResponse)(nil), "tsuki.tokens.TokenRatesByDenomResponse")
	proto.RegisterMapType((map[string]*TokenRate)(nil), "tsuki.tokens.TokenRatesByDenomResponse.DataEntry")
	proto.RegisterType((*TokenBlackWhitesRequest)(nil), "tsuki.tokens.TokenBlackWhitesRequest")
	proto.RegisterType((*TokenBlackWhitesResponse)(nil), "tsuki.tokens.TokenBlackWhitesResponse")
}

func init() { proto.RegisterFile("tsuki/tokens/query.proto", fileDescriptor_c8db6e46fba94960) }
...
func (c *queryClient) GetTokenAlias(ctx context.Context, in *TokenAliasRequest, opts ...grpc.CallOption) (*TokenAliasResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.tokens.Query/GetTokenAlias", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetTokenAliasesByDenom(ctx context.Context, in *TokenAliasesByDenomRequest, opts ...grpc.CallOption) (*TokenAliasesByDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.tokens.Query/GetTokenAliasesByDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetTokenRate(ctx context.Context, in *TokenRateRequest, opts ...grpc.CallOption) (*TokenRateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.tokens.Query/GetTokenRate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetTokenRatesByDenom(ctx context.Context, in *TokenRatesByDenomRequest, opts ...grpc.CallOption) (*TokenRatesByDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.tokens.Query/GetTokenRatesByDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetTokenBlackWhites(ctx context.Context, in *TokenBlackWhitesRequest, opts ...grpc.CallOption) (*TokenBlackWhitesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.tokens.Query/GetTokenBlackWhites", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetTokenAlias_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.tokens.Query/GetTokenAlias",
	}
...
func _Query_GetTokenAliasesByDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.tokens.Query/GetTokenAliasesByDenom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GetTokenRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.tokens.Query/GetTokenRate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GetTokenRatesByDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.tokens.Query/GetTokenRatesByDenom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GetTokenBlackWhites_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.tokens.Query/GetTokenBlackWhites",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
