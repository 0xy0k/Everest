...
func init() {
	proto.RegisterType((*TokenAliasRequest)(nil), "tsuki.gov.TokenAliasRequest")
	proto.RegisterType((*TokenAliasResponse)(nil), "tsuki.gov.TokenAliasResponse")
}
...
func (c *queryClient) GetTokenAlias(ctx context.Context, in *TokenAliasRequest, opts ...grpc.CallOption) (*TokenAliasResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.gov.Query/GetTokenAlias", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetTokenAlias_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.gov.Query/GetTokenAlias",
	}
