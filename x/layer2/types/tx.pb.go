...
func init() {
	...
	proto.RegisterType((*MsgJoinDappVerifierWithBond)(nil), "tsuki.layer2.MsgJoinDappVerifierWithBond")
	proto.RegisterType((*MsgJoinDappVerifierWithBondResponse)(nil), "tsuki.layer2.MsgJoinDappVerifierWithBondResponse")
	...
	proto.RegisterType((*MsgAckTransferDappTx)(nil), "tsuki.layer2.MsgAckTransferDappTx")
	proto.RegisterType((*MsgAckTransferDappTxResponse)(nil), "tsuki.layer2.MsgAckTransferDappTxResponse")
...
func (c *msgClient) JoinDappVerifierWithBond(ctx context.Context, in *MsgJoinDappVerifierWithBond, opts ...grpc.CallOption) (*MsgJoinDappVerifierWithBondResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.layer2.Msg/JoinDappVerifierWithBond", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AckTransferDappTx(ctx context.Context, in *MsgAckTransferDappTx, opts ...grpc.CallOption) (*MsgAckTransferDappTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.layer2.Msg/AckTransferDappTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_JoinDappVerifierWithBond_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.layer2.Msg/JoinDappVerifierWithBond",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_AckTransferDappTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.layer2.Msg/AckTransferDappTx",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
