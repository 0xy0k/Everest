...
func init() {
	...
	proto.RegisterType((*MsgExitDapp)(nil), "tsuki.layer2.MsgExitDapp")
	proto.RegisterType((*MsgExitDappResponse)(nil), "tsuki.layer2.MsgExitDappResponse")
...
func (c *msgClient) ExitDapp(ctx context.Context, in *MsgExitDapp, opts ...grpc.CallOption) (*MsgExitDappResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.layer2.Msg/ExitDapp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_ExitDapp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.layer2.Msg/ExitDapp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
