...
type Dapp struct {
	...
	Status        DappStatus                              `protobuf:"varint,19,opt,name=status,proto3,enum=tsuki.layer2.DappStatus" json:"status,omitempty"`
...
type DappSession struct {
	...
	Status     SessionStatus `protobuf:"varint,5,opt,name=status,proto3,enum=tsuki.layer2.SessionStatus" json:"status,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*DappOperatorCandidate)(nil), "tsuki.layer2.DappOperatorCandidate")
