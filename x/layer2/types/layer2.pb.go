...
// source: tsuki/layer2/layer2.proto
...
type Dapp struct {
	...
	Status           DappStatus                              `protobuf:"varint,18,opt,name=status,proto3,enum=tsuki.layer2.DappStatus" json:"status,omitempty"`
...
type DappOperator struct {
	...
	Status           OperatorStatus                         `protobuf:"varint,6,opt,name=status,proto3,enum=tsuki.layer2.OperatorStatus" json:"status,omitempty"`
...
type DappSession struct {
	...
	Status          SessionStatus `protobuf:"varint,4,opt,name=status,proto3,enum=tsuki.layer2.SessionStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("tsuki.layer2.DappStatus", DappStatus_name, DappStatus_value)
	proto.RegisterEnum("tsuki.layer2.OperatorStatus", OperatorStatus_name, OperatorStatus_value)
	proto.RegisterEnum("tsuki.layer2.SessionStatus", SessionStatus_name, SessionStatus_value)
	proto.RegisterType((*AccountRange)(nil), "tsuki.layer2.AccountRange")
	proto.RegisterType((*Controllers)(nil), "tsuki.layer2.Controllers")
	proto.RegisterType((*BinaryInfo)(nil), "tsuki.layer2.BinaryInfo")
	proto.RegisterType((*LpPoolConfig)(nil), "tsuki.layer2.LpPoolConfig")
	proto.RegisterType((*IssuranceConfig)(nil), "tsuki.layer2.IssuranceConfig")
	proto.RegisterType((*Dapp)(nil), "tsuki.layer2.Dapp")
	proto.RegisterType((*UserDappBond)(nil), "tsuki.layer2.UserDappBond")
	proto.RegisterType((*DappOperator)(nil), "tsuki.layer2.DappOperator")
	proto.RegisterType((*DappLeaderDenouncement)(nil), "tsuki.layer2.DappLeaderDenouncement")
	proto.RegisterType((*DappSession)(nil), "tsuki.layer2.DappSession")
	proto.RegisterType((*DappSessionApproval)(nil), "tsuki.layer2.DappSessionApproval")
	proto.RegisterType((*ExecutionRegistrar)(nil), "tsuki.layer2.ExecutionRegistrar")
	proto.RegisterType((*BridgeRegistrarHelper)(nil), "tsuki.layer2.BridgeRegistrarHelper")
	proto.RegisterType((*BridgeRegistrar)(nil), "tsuki.layer2.BridgeRegistrar")
	proto.RegisterType((*BridgeBalance)(nil), "tsuki.layer2.BridgeBalance")
	proto.RegisterType((*BridgeAccount)(nil), "tsuki.layer2.BridgeAccount")
	proto.RegisterType((*BridgeToken)(nil), "tsuki.layer2.BridgeToken")
	proto.RegisterType((*XAMRequest)(nil), "tsuki.layer2.XAMRequest")
	proto.RegisterType((*XAMResponse)(nil), "tsuki.layer2.XAMResponse")
	proto.RegisterType((*XAM)(nil), "tsuki.layer2.XAM")
}

func init() { proto.RegisterFile("tsuki/layer2/layer2.proto", fileDescriptor_4070283bbe72a11a) }
