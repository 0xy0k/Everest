...
func init() {
	...
	proto.RegisterType((*QueryTransferDappRequest)(nil), "tsuki.layer2.QueryTransferDappRequest")
	proto.RegisterType((*QueryTransferDappResponse)(nil), "tsuki.layer2.QueryTransferDappResponse")
...
func (c *queryClient) TransferDapp(ctx context.Context, in *QueryTransferDappRequest, opts ...grpc.CallOption) (*QueryTransferDappResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.layer2.Query/TransferDapp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_TransferDapp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.layer2.Query/TransferDapp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
