...
// source: tsuki/layer2/query.proto
...
func init() {
	proto.RegisterType((*QueryExecutionRegistrarRequest)(nil), "tsuki.layer2.QueryExecutionRegistrarRequest")
	proto.RegisterType((*QueryExecutionRegistrarResponse)(nil), "tsuki.layer2.QueryExecutionRegistrarResponse")
	proto.RegisterType((*QueryAllDappsRequest)(nil), "tsuki.layer2.QueryAllDappsRequest")
	proto.RegisterType((*QueryAllDappsResponse)(nil), "tsuki.layer2.QueryAllDappsResponse")
	proto.RegisterType((*QueryTransferDappsRequest)(nil), "tsuki.layer2.QueryTransferDappsRequest")
	proto.RegisterType((*QueryTransferDappsResponse)(nil), "tsuki.layer2.QueryTransferDappsResponse")
	proto.RegisterType((*QueryGlobalTokensRequest)(nil), "tsuki.layer2.QueryGlobalTokensRequest")
	proto.RegisterType((*QueryGlobalTokensResponse)(nil), "tsuki.layer2.QueryGlobalTokensResponse")
}

func init() { proto.RegisterFile("tsuki/layer2/query.proto", fileDescriptor_b9c14366296fd7f4) }
...
type QueryClient interface {
	...
	// executor or verifier tsuki public key (e.g. list all dApps run by address tsukiXXX…YYY)
...
func (c *queryClient) ExecutionRegistrar(ctx context.Context, in *QueryExecutionRegistrarRequest, opts ...grpc.CallOption) (*QueryExecutionRegistrarResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.layer2.Query/ExecutionRegistrar", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllDapps(ctx context.Context, in *QueryAllDappsRequest, opts ...grpc.CallOption) (*QueryAllDappsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.layer2.Query/AllDapps", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TransferDapps(ctx context.Context, in *QueryTransferDappsRequest, opts ...grpc.CallOption) (*QueryTransferDappsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.layer2.Query/TransferDapps", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GlobalTokens(ctx context.Context, in *QueryGlobalTokensRequest, opts ...grpc.CallOption) (*QueryGlobalTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.layer2.Query/GlobalTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ExecutionRegistrar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.layer2.Query/ExecutionRegistrar",
	}
...
func _Query_AllDapps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.layer2.Query/AllDapps",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TransferDapps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.layer2.Query/TransferDapps",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GlobalTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.layer2.Query/GlobalTokens",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.layer2.Query",
	...
	Metadata: "tsuki/layer2/query.proto",
}
