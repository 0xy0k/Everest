...
// source: tsuki/layer2/mint.proto
...
func init() {
	proto.RegisterType((*TokenInfo)(nil), "tsuki.layer2.TokenInfo")
}

func init() { proto.RegisterFile("tsuki/layer2/mint.proto", fileDescriptor_066d1ba7ae573fa3) }
