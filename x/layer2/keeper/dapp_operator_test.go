...
func (suite *KeeperTestSuite) TestDappOperatorSetGetDelete() {
	operators := []types.DappOperator{
		{
			DappName:       "dapp1",
			Operator:       "tsuki1q24436yrnettd6v4eu6r4t9gycnnddack4jr5r",
			Executor:       true,
			Verifier:       true,
			Interx:         "tsuki1q24436yrnettd6v4eu6r4t9gycnnddack4jr5r",
		...
		{
			DappName:       "dapp1",
			Operator:       "tsuki1alzyfq40zjsveat87jlg8jxetwqmr0a29sgd0f",
			Executor:       true,
			Verifier:       false,
			Interx:         "tsuki1alzyfq40zjsveat87jlg8jxetwqmr0a29sgd0f",
			Status:         types.OperatorActive,
			Rank:           1,
			Streak:         1,
