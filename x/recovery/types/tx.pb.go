...
// source: tsuki/recovery/tx.proto
...
func init() {
	proto.RegisterType((*MsgRegisterRecoverySecret)(nil), "tsuki.recovery.MsgRegisterRecoverySecret")
	proto.RegisterType((*MsgRegisterRecoverySecretResponse)(nil), "tsuki.recovery.MsgRegisterRecoverySecretResponse")
	proto.RegisterType((*MsgRotateRecoveryAddress)(nil), "tsuki.recovery.MsgRotateRecoveryAddress")
	proto.RegisterType((*MsgRotateRecoveryAddressResponse)(nil), "tsuki.recovery.MsgRotateRecoveryAddressResponse")
	proto.RegisterType((*MsgIssueRecoveryTokens)(nil), "tsuki.recovery.MsgIssueRecoveryTokens")
	proto.RegisterType((*MsgIssueRecoveryTokensResponse)(nil), "tsuki.recovery.MsgIssueRecoveryTokensResponse")
	proto.RegisterType((*MsgBurnRecoveryTokens)(nil), "tsuki.recovery.MsgBurnRecoveryTokens")
	proto.RegisterType((*MsgBurnRecoveryTokensResponse)(nil), "tsuki.recovery.MsgBurnRecoveryTokensResponse")
	proto.RegisterType((*MsgClaimRRHolderRewards)(nil), "tsuki.recovery.MsgClaimRRHolderRewards")
	proto.RegisterType((*MsgClaimRRHolderRewardsResponse)(nil), "tsuki.recovery.MsgClaimRRHolderRewardsResponse")
	proto.RegisterType((*MsgRegisterRRTokenHolder)(nil), "tsuki.recovery.MsgRegisterRRTokenHolder")
	proto.RegisterType((*MsgRegisterRRTokenHolderResponse)(nil), "tsuki.recovery.MsgRegisterRRTokenHolderResponse")
	proto.RegisterType((*MsgRotateValidatorByHalfRRTokenHolder)(nil), "tsuki.recovery.MsgRotateValidatorByHalfRRTokenHolder")
	proto.RegisterType((*MsgRotateValidatorByHalfRRTokenHolderResponse)(nil), "tsuki.recovery.MsgRotateValidatorByHalfRRTokenHolderResponse")
}

func init() { proto.RegisterFile("tsuki/recovery/tx.proto", fileDescriptor_8b5bb529d56b66ae) }
...
type MsgClient interface {
	...
	// allow ANY TSUKI address that knows the recovery secret to rotate the address
	...
	// allow ANY TSUKI address has a sufficient number of RR tokens to rotate the address
...
func (c *msgClient) RegisterRecoverySecret(ctx context.Context, in *MsgRegisterRecoverySecret, opts ...grpc.CallOption) (*MsgRegisterRecoverySecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Msg/RegisterRecoverySecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RotateRecoveryAddress(ctx context.Context, in *MsgRotateRecoveryAddress, opts ...grpc.CallOption) (*MsgRotateRecoveryAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Msg/RotateRecoveryAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) IssueRecoveryTokens(ctx context.Context, in *MsgIssueRecoveryTokens, opts ...grpc.CallOption) (*MsgIssueRecoveryTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Msg/IssueRecoveryTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BurnRecoveryTokens(ctx context.Context, in *MsgBurnRecoveryTokens, opts ...grpc.CallOption) (*MsgBurnRecoveryTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Msg/BurnRecoveryTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimRRHolderRewards(ctx context.Context, in *MsgClaimRRHolderRewards, opts ...grpc.CallOption) (*MsgClaimRRHolderRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Msg/ClaimRRHolderRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RegisterRRTokenHolder(ctx context.Context, in *MsgRegisterRRTokenHolder, opts ...grpc.CallOption) (*MsgRegisterRRTokenHolderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Msg/RegisterRRTokenHolder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RotateValidatorByHalfRRTokenHolder(ctx context.Context, in *MsgRotateValidatorByHalfRRTokenHolder, opts ...grpc.CallOption) (*MsgRotateValidatorByHalfRRTokenHolderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Msg/RotateValidatorByHalfRRTokenHolder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RegisterRecoverySecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Msg/RegisterRecoverySecret",
	}
...
func _Msg_RotateRecoveryAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Msg/RotateRecoveryAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_IssueRecoveryTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Msg/IssueRecoveryTokens",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_BurnRecoveryTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Msg/BurnRecoveryTokens",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ClaimRRHolderRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Msg/ClaimRRHolderRewards",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RegisterRRTokenHolder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Msg/RegisterRRTokenHolder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RotateValidatorByHalfRRTokenHolder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Msg/RotateValidatorByHalfRRTokenHolder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.recovery.Msg",
	...
	Metadata: "tsuki/recovery/tx.proto",
}
