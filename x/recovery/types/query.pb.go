...
// source: tsuki/recovery/query.proto
...
func init() {
	proto.RegisterType((*QueryRecoveryRecordRequest)(nil), "tsuki.recovery.QueryRecoveryRecordRequest")
	proto.RegisterType((*QueryRecoveryRecordResponse)(nil), "tsuki.recovery.QueryRecoveryRecordResponse")
	proto.RegisterType((*QueryRecoveryTokenRequest)(nil), "tsuki.recovery.QueryRecoveryTokenRequest")
	proto.RegisterType((*QueryRecoveryTokenResponse)(nil), "tsuki.recovery.QueryRecoveryTokenResponse")
	proto.RegisterType((*QueryRRHolderRewardsRequest)(nil), "tsuki.recovery.QueryRRHolderRewardsRequest")
	proto.RegisterType((*QueryRRHolderRewardsResponse)(nil), "tsuki.recovery.QueryRRHolderRewardsResponse")
	proto.RegisterType((*QueryRegisteredRRTokenHoldersRequest)(nil), "tsuki.recovery.QueryRegisteredRRTokenHoldersRequest")
	proto.RegisterType((*QueryRegisteredRRTokenHoldersResponse)(nil), "tsuki.recovery.QueryRegisteredRRTokenHoldersResponse")
}

func init() { proto.RegisterFile("tsuki/recovery/query.proto", fileDescriptor_1ccd2ab45d9acb75) }
...
func (c *queryClient) RecoveryRecord(ctx context.Context, in *QueryRecoveryRecordRequest, opts ...grpc.CallOption) (*QueryRecoveryRecordResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Query/RecoveryRecord", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) RecoveryToken(ctx context.Context, in *QueryRecoveryTokenRequest, opts ...grpc.CallOption) (*QueryRecoveryTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Query/RecoveryToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) RRHolderRewards(ctx context.Context, in *QueryRRHolderRewardsRequest, opts ...grpc.CallOption) (*QueryRRHolderRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Query/RRHolderRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) RegisteredRRTokenHolders(ctx context.Context, in *QueryRegisteredRRTokenHoldersRequest, opts ...grpc.CallOption) (*QueryRegisteredRRTokenHoldersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.recovery.Query/RegisteredRRTokenHolders", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_RecoveryRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Query/RecoveryRecord",
	}
...
func _Query_RecoveryToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Query/RecoveryToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_RRHolderRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Query/RRHolderRewards",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_RegisteredRRTokenHolders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.recovery.Query/RegisteredRRTokenHolders",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "tsuki.recovery.Query",
	...
	Metadata: "tsuki/recovery/query.proto",
}
