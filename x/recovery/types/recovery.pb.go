...
// source: tsuki/recovery/recovery.proto
...
func init() {
	proto.RegisterType((*RecoveryRecord)(nil), "tsuki.recovery.RecoveryRecord")
	proto.RegisterType((*RecoveryToken)(nil), "tsuki.recovery.RecoveryToken")
	proto.RegisterType((*Rotation)(nil), "tsuki.recovery.Rotation")
	proto.RegisterType((*Rewards)(nil), "tsuki.recovery.Rewards")
}

func init() { proto.RegisterFile("tsuki/recovery/recovery.proto", fileDescriptor_c2745d5958530d7f) }
