...
$ <appd> query recovery recovery-record tsuki15nxzg5lrmyu42vuzlztdnlhq9sngerenu520ey
`),
...
$ <appd> query recovery recovery-token tsuki15nxzg5lrmyu42vuzlztdnlhq9sngerenu520ey
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx := client.GetClientContextFromCmd(cmd)
...
$ <appd> query recovery rr-holder-rewards tsuki15nxzg5lrmyu42vuzlztdnlhq9sngerenu520ey
`),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx := client.GetClientContextFromCmd(cmd)
