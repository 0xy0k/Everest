...
func init() {
	...
	proto.RegisterType((*QueryFeesCollectedRequest)(nil), "tsuki.distributor.QueryFeesCollectedRequest")
	proto.RegisterType((*QueryFeesCollectedResponse)(nil), "tsuki.distributor.QueryFeesCollectedResponse")
...
func (c *queryClient) FeesCollected(ctx context.Context, in *QueryFeesCollectedRequest, opts ...grpc.CallOption) (*QueryFeesCollectedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tsuki.distributor.Query/FeesCollected", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_FeesCollected_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tsuki.distributor.Query/FeesCollected",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
