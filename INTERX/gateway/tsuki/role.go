...
// RegisterTsukiGovRoleRoutes registers tsuki gov roles query routers.
func RegisterTsukiGovRoleRoutes(r *mux.Router, gwCosmosmux *runtime.ServeMux, rpcAddr string) {
...
func queryRolesByAddressHandler(r *http.Request, gwCosmosmux *runtime.ServeMux) (interface{}, interface{}, int) {
	...
	r.URL.Path = fmt.Sprintf("/api/tsuki/gov/roles_by_address/%s", base64.URLEncoding.EncodeToString(accAddr.Bytes()))
	return common.ServeGRPC(r, gwCosmosmux)
}
