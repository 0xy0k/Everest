...
// RegisterTsukiGovPermissionRoutes registers tsuki gov permissions query routers.
func RegisterTsukiGovPermissionRoutes(r *mux.Router, gwCosmosmux *runtime.ServeMux, rpcAddr string) {
...
func queryPermissionsByAddressHandler(r *http.Request, gwCosmosmux *runtime.ServeMux) (interface{}, interface{}, int) {
	...
	r.URL.Path = fmt.Sprintf("/api/tsuki/gov/permissions_by_address/%s", base64.URLEncoding.EncodeToString(accAddr.Bytes()))
