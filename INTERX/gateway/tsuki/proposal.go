...
import (
	...
	govTypes "github.com/TsukiCore/tsuki/INTERX/types/tsuki/gov"
	sdk "github.com/cosmos/cosmos-sdk/types"
	"github.com/gorilla/mux"
	"github.com/grpc-ecosystem/grpc-gateway/runtime"
)

// RegisterTsukiGovProposalRoutes registers tsuki gov proposal query routers.
func RegisterTsukiGovProposalRoutes(r *mux.Router, gwCosmosmux *runtime.ServeMux, rpcAddr string) {
