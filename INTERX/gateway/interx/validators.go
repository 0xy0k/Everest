...
func queryValidatorsHandle(r *http.Request, gwCosmosmux *runtime.ServeMux) (interface{}, interface{}, int) {
	...
	validatorsJSON := `{
		"validators": [
			{
				"address": "tsuki1lrh9pcmlnywlpphj8vtm0j0alhrrjwjsdxmjts",
				"valkey": "tsukivaloper1lrh9pcmlnywlpphj8vtm0j0alhrrjwjs7q83nu",
				"pubkey": "tsukivalconspub1zcjduepqm98ffgul4ppzzur6l67v3mj2vsyc7tr9nrzwk3e0ffx0z7l9sgsqnln467",
				"moniker": "hello",
				"website": "",
				"social": "social",
				"identity": "",
