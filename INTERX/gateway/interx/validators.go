...
import (
	...
	"github.com/TsukiCore/tsuki/INTERX/types/tsuki"
...
func queryValidatorsHandle(r *http.Request, gwCosmosmux *runtime.ServeMux, rpcAddr string) (interface{}, interface{}, int) {
	...
	if success != nil {
		...
		for index, validator := range result.Validators {
			...
			tsukiStatus := common.GetTsukiStatus(rpcAddr)

			if signInfoRes != nil && networkPropertiesRes != nil && tsukiStatus != nil {
				...
				latestBlockHeight, _ := strconv.ParseInt(tsukiStatus.SyncInfo.LatestBlockHeight, 10, 64)
...
func queryConsensusHandle(r *http.Request, gwCosmosmux *runtime.ServeMux, rpcAddr string) (interface{}, interface{}, int) {
	...
	if success != nil {
		...
		response := tsuki.ConsensusResponse{}
