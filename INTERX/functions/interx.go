...
func RegisterInterxFunctions() {
	...
	AddInterxFunction(
		"QueryTsukiStatus",
		config.QueryTsukiStatus,
		`{
			"description": "QueryTsukiStatus is a function to query the node status",
			"response": {
				"node_info": {
	...
	AddInterxFunction(
		...
		`{
			...
			"parameters": {
				"val_addr": {
					"type":        "string",
					"description": "This represents the tsuki account address.",
					"optional": true
				}
			}
		}`,
	...
	AddInterxFunction(
		...
		`{
			...
			"response": {
				"address": {
					"description": "The faucet tsuki address"
				},
				"balances": {
	...
	AddInterxFunction(
		...
		`{
			...
			"parameters": {
				...
				"address": {
					"type":        "string",
					"description": "This is an option to query validator by a given tsuki address",
					"optional": true
				},
				"valkey": {
					"type":        "string",
	...
	AddInterxFunction(
		...
		`{
			...
			"response": {
				...
				"proposer": {
					"description": "The current proposer tsuki address"
				},
				"round": {
	...
	AddInterxFunction(
		"QueryTsukiFunctions",
		config.QueryTsukiFunctions,
		`{
			"description": "QueryTsukiFunctions is a function to query tsuki functions."
		}`,
	)
