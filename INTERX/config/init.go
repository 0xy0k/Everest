...
func getRPCSettings() RPCConfig {
	...
	config.API["GET"][QueryTsukiStatus] = defaultRPCSetting
	...
	config.API["GET"][QueryTsukiTokensAliases] = defaultRPCSetting
	config.API["GET"][QueryTsukiTokensRates] = defaultRPCSetting
