...
// 	protoc        v3.11.2
// source: tsuki/tokens/proposal.proto
...
type MsgProposalUpsertTokenAlias struct {
	...
	Name        string   `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`          // Token Name (e.g. Cosmos, Tsuki, Bitcoin)
...
func (x *MsgProposalUpsertTokenAlias) Reset() {
	*x = MsgProposalUpsertTokenAlias{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tsuki_tokens_proposal_proto_msgTypes[0]
...
func (*MsgProposalUpsertTokenAlias) Descriptor() ([]byte, []int) {
	return file_tsuki_tokens_proposal_proto_rawDescGZIP(), []int{0}
}
...
func (x *ProposalUpsertTokenAlias) Reset() {
	*x = ProposalUpsertTokenAlias{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tsuki_tokens_proposal_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProposalUpsertTokenAlias) Descriptor() ([]byte, []int) {
	return file_tsuki_tokens_proposal_proto_rawDescGZIP(), []int{1}
}
...
func (x *MsgProposalUpsertTokenRates) Reset() {
	*x = MsgProposalUpsertTokenRates{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tsuki_tokens_proposal_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MsgProposalUpsertTokenRates) Descriptor() ([]byte, []int) {
	return file_tsuki_tokens_proposal_proto_rawDescGZIP(), []int{2}
}
...
func (x *ProposalUpsertTokenRates) Reset() {
	*x = ProposalUpsertTokenRates{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tsuki_tokens_proposal_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ProposalUpsertTokenRates) Descriptor() ([]byte, []int) {
	return file_tsuki_tokens_proposal_proto_rawDescGZIP(), []int{3}
}
...
var File_tsuki_tokens_proposal_proto protoreflect.FileDescriptor

var file_tsuki_tokens_proposal_proto_rawDesc = []byte{
...
var (
	file_tsuki_tokens_proposal_proto_rawDescOnce sync.Once
	file_tsuki_tokens_proposal_proto_rawDescData = file_tsuki_tokens_proposal_proto_rawDesc
)

func file_tsuki_tokens_proposal_proto_rawDescGZIP() []byte {
	file_tsuki_tokens_proposal_proto_rawDescOnce.Do(func() {
		file_tsuki_tokens_proposal_proto_rawDescData = protoimpl.X.CompressGZIP(file_tsuki_tokens_proposal_proto_rawDescData)
	})
	return file_tsuki_tokens_proposal_proto_rawDescData
}

var file_tsuki_tokens_proposal_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_tsuki_tokens_proposal_proto_goTypes = []interface{}{
	(*MsgProposalUpsertTokenAlias)(nil), // 0: tsuki.tokens.MsgProposalUpsertTokenAlias
	(*ProposalUpsertTokenAlias)(nil),    // 1: tsuki.tokens.ProposalUpsertTokenAlias
	(*MsgProposalUpsertTokenRates)(nil), // 2: tsuki.tokens.MsgProposalUpsertTokenRates
	(*ProposalUpsertTokenRates)(nil),    // 3: tsuki.tokens.ProposalUpsertTokenRates
}
var file_tsuki_tokens_proposal_proto_depIdxs = []int32{
...
func init() { file_tsuki_tokens_proposal_proto_init() }
func file_tsuki_tokens_proposal_proto_init() {
	if File_tsuki_tokens_proposal_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_tsuki_tokens_proposal_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tsuki_tokens_proposal_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tsuki_tokens_proposal_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tsuki_tokens_proposal_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_tsuki_tokens_proposal_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_tsuki_tokens_proposal_proto_goTypes,
		DependencyIndexes: file_tsuki_tokens_proposal_proto_depIdxs,
		MessageInfos:      file_tsuki_tokens_proposal_proto_msgTypes,
	}.Build()
	File_tsuki_tokens_proposal_proto = out.File
	file_tsuki_tokens_proposal_proto_rawDesc = nil
	file_tsuki_tokens_proposal_proto_goTypes = nil
	file_tsuki_tokens_proposal_proto_depIdxs = nil
}
