...
// 	protoc        v3.11.2
// source: tsuki/gov/permission.proto
...
func (PermValue) Descriptor() protoreflect.EnumDescriptor {
	return file_tsuki_gov_permission_proto_enumTypes[0].Descriptor()
}

func (PermValue) Type() protoreflect.EnumType {
	return &file_tsuki_gov_permission_proto_enumTypes[0]
}
...
func (PermValue) EnumDescriptor() ([]byte, []int) {
	return file_tsuki_gov_permission_proto_rawDescGZIP(), []int{0}
}

var File_tsuki_gov_permission_proto protoreflect.FileDescriptor

var file_tsuki_gov_permission_proto_rawDesc = []byte{
...
var (
	file_tsuki_gov_permission_proto_rawDescOnce sync.Once
	file_tsuki_gov_permission_proto_rawDescData = file_tsuki_gov_permission_proto_rawDesc
)

func file_tsuki_gov_permission_proto_rawDescGZIP() []byte {
	file_tsuki_gov_permission_proto_rawDescOnce.Do(func() {
		file_tsuki_gov_permission_proto_rawDescData = protoimpl.X.CompressGZIP(file_tsuki_gov_permission_proto_rawDescData)
	})
	return file_tsuki_gov_permission_proto_rawDescData
}

var file_tsuki_gov_permission_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_tsuki_gov_permission_proto_goTypes = []interface{}{
	(PermValue)(0), // 0: tsuki.gov.PermValue
}
var file_tsuki_gov_permission_proto_depIdxs = []int32{
...
func init() { file_tsuki_gov_permission_proto_init() }
func file_tsuki_gov_permission_proto_init() {
	if File_tsuki_gov_permission_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_tsuki_gov_permission_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_tsuki_gov_permission_proto_goTypes,
		DependencyIndexes: file_tsuki_gov_permission_proto_depIdxs,
		EnumInfos:         file_tsuki_gov_permission_proto_enumTypes,
	}.Build()
	File_tsuki_gov_permission_proto = out.File
	file_tsuki_gov_permission_proto_rawDesc = nil
	file_tsuki_gov_permission_proto_goTypes = nil
	file_tsuki_gov_permission_proto_depIdxs = nil
}
