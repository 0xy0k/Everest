...
var file_tsuki_gov_query_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_tsuki_gov_query_proto_goTypes = []interface{}{
	(*QueryDataReferenceKeysRequest)(nil),  // 0: tsuki.gov.QueryDataReferenceKeysRequest
	(*QueryDataReferenceKeysResponse)(nil), // 1: tsuki.gov.QueryDataReferenceKeysResponse
	(*QueryDataReferenceRequest)(nil),      // 2: tsuki.gov.QueryDataReferenceRequest
	(*QueryDataReferenceResponse)(nil),     // 3: tsuki.gov.QueryDataReferenceResponse
	(*PageRequest)(nil),                    // 4: tsuki.gov.PageRequest
	(*PageResponse)(nil),                   // 5: tsuki.gov.PageResponse
	(*DataRegistryEntry)(nil),              // 6: tsuki.gov.DataRegistryEntry
}
var file_tsuki_gov_query_proto_depIdxs = []int32{
	4, // 0: tsuki.gov.QueryDataReferenceKeysRequest.pagination:type_name -> tsuki.gov.PageRequest
	5, // 1: tsuki.gov.QueryDataReferenceKeysResponse.pagination:type_name -> tsuki.gov.PageResponse
	6, // 2: tsuki.gov.QueryDataReferenceResponse.data:type_name -> tsuki.gov.DataRegistryEntry
	0, // 3: tsuki.gov.Query.GetAllDataReferenceKeys:input_type -> tsuki.gov.QueryDataReferenceKeysRequest
	2, // 4: tsuki.gov.Query.GetDataReferenceByKey:input_type -> tsuki.gov.QueryDataReferenceRequest
	1, // 5: tsuki.gov.Query.GetAllDataReferenceKeys:output_type -> tsuki.gov.QueryDataReferenceKeysResponse
	3, // 6: tsuki.gov.Query.GetDataReferenceByKey:output_type -> tsuki.gov.QueryDataReferenceResponse
