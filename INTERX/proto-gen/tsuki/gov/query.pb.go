...
var file_tsuki_gov_query_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_tsuki_gov_query_proto_goTypes = []interface{}{
	...
	(*Proposal)(nil),                       // 8: tsuki.gov.Proposal
	(*PageRequest)(nil),                    // 9: tsuki.gov.PageRequest
	(*PageResponse)(nil),                   // 10: tsuki.gov.PageResponse
	(*DataRegistryEntry)(nil),              // 11: tsuki.gov.DataRegistryEntry
}
var file_tsuki_gov_query_proto_depIdxs = []int32{
	8,  // 0: tsuki.gov.QueryProposalResponse.proposal:type_name -> tsuki.gov.Proposal
	8,  // 1: tsuki.gov.QueryProposalsResponse.proposals:type_name -> tsuki.gov.Proposal
	9,  // 2: tsuki.gov.QueryDataReferenceKeysRequest.pagination:type_name -> tsuki.gov.PageRequest
	10, // 3: tsuki.gov.QueryDataReferenceKeysResponse.pagination:type_name -> tsuki.gov.PageResponse
	11, // 4: tsuki.gov.QueryDataReferenceResponse.data:type_name -> tsuki.gov.DataRegistryEntry
	0,  // 5: tsuki.gov.Query.Proposal:input_type -> tsuki.gov.QueryProposalRequest
	2,  // 6: tsuki.gov.Query.Proposals:input_type -> tsuki.gov.QueryProposalsRequest
	4,  // 7: tsuki.gov.Query.GetAllDataReferenceKeys:input_type -> tsuki.gov.QueryDataReferenceKeysRequest
	6,  // 8: tsuki.gov.Query.GetDataReferenceByKey:input_type -> tsuki.gov.QueryDataReferenceRequest
	1,  // 9: tsuki.gov.Query.Proposal:output_type -> tsuki.gov.QueryProposalResponse
	3,  // 10: tsuki.gov.Query.Proposals:output_type -> tsuki.gov.QueryProposalsResponse
	5,  // 11: tsuki.gov.Query.GetAllDataReferenceKeys:output_type -> tsuki.gov.QueryDataReferenceKeysResponse
	7,  // 12: tsuki.gov.Query.GetDataReferenceByKey:output_type -> tsuki.gov.QueryDataReferenceResponse
