...
var file_tsuki_gov_proposal_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_tsuki_gov_proposal_proto_goTypes = []interface{}{
	...
	(NetworkProperty)(0),                      // 15: tsuki.gov.NetworkProperty
}
var file_tsuki_gov_proposal_proto_depIdxs = []int32{
	...
	13, // 2: tsuki.gov.Proposal.content:type_name -> google.protobuf.Any
	14, // 3: tsuki.gov.Proposal.submit_time:type_name -> google.protobuf.Timestamp
	14, // 4: tsuki.gov.Proposal.voting_start_time:type_name -> google.protobuf.Timestamp
	14, // 5: tsuki.gov.Proposal.voting_end_time:type_name -> google.protobuf.Timestamp
	14, // 6: tsuki.gov.Proposal.enactment_end_time:type_name -> google.protobuf.Timestamp
	1,  // 7: tsuki.gov.Proposal.result:type_name -> tsuki.gov.VoteResult
	15, // 8: tsuki.gov.MsgProposalSetNetworkProperty.network_property:type_name -> tsuki.gov.NetworkProperty
	15, // 9: tsuki.gov.SetNetworkPropertyProposal.network_property:type_name -> tsuki.gov.NetworkProperty
