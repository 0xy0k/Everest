...
var file_tsuki_gov_proposal_proto_depIdxs = []int32{
	...
	14, // 4: tsuki.gov.Proposal.voting_end_time:type_name -> google.protobuf.Timestamp
	14, // 5: tsuki.gov.Proposal.enactment_end_time:type_name -> google.protobuf.Timestamp
	1,  // 6: tsuki.gov.Proposal.result:type_name -> tsuki.gov.VoteResult
	15, // 7: tsuki.gov.MsgProposalSetNetworkProperty.network_property:type_name -> tsuki.gov.NetworkProperty
	15, // 8: tsuki.gov.SetNetworkPropertyProposal.network_property:type_name -> tsuki.gov.NetworkProperty
