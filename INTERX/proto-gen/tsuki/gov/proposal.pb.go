...
type Vote struct {
	...
	Option     VoteOption `protobuf:"varint,3,opt,name=option,proto3,enum=tsuki.gov.VoteOption" json:"option"`
}
...
type Proposal struct {
	...
	Result           VoteResult           `protobuf:"varint,8,opt,name=result,proto3,enum=tsuki.gov.VoteResult" json:"result"`
}
...
type MsgProposalSetNetworkProperty struct {
	...
	Proposer        []byte          `protobuf:"bytes,1,opt,name=proposer,proto3" json:"proposer"`
	NetworkProperty NetworkProperty `protobuf:"varint,2,opt,name=network_property,json=networkProperty,proto3,enum=tsuki.gov.NetworkProperty" json:"network_property"` // enum value
...
type SetNetworkPropertyProposal struct {
	...
	NetworkProperty NetworkProperty `protobuf:"varint,1,opt,name=network_property,json=networkProperty,proto3,enum=tsuki.gov.NetworkProperty" json:"network_property"`
