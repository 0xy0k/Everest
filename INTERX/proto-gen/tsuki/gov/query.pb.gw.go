...
var (
	pattern_Query_Proposal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "proposals", "proposal_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Proposals_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "tsuki", "gov", "proposals"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AllDataReferenceKeys_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "tsuki", "gov", "data_keys"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DataReferenceByKey_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "data", "key"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_WhitelistedProposalVoters_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "voters", "proposal_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Votes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "votes", "proposal_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_NetworkProperties_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "tsuki", "gov", "network_properties"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_IdentityRecord_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "identity_record", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_IdentityRecordsByAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "identity_records", "creator"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AllIdentityRecords_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "tsuki", "gov", "all_identity_records"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_IdentityRecordVerifyRequest_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "identity_verify_record", "request_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_IdentityRecordVerifyRequestsByRequester_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "identity_verify_requests_by_requester", "requester"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_IdentityRecordVerifyRequestsByApprover_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "identity_verify_requests_by_approver", "approver"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AllIdentityRecordVerifyRequests_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "tsuki", "gov", "all_identity_verify_requests"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AllRoles_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "tsuki", "gov", "all_roles"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RolesByAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "roles_by_address", "val_addr"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PermissionsByAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "permissions_by_address", "val_addr"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RolePermissions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "tsuki", "gov", "permissions_by_role", "identifier"}, "", runtime.AssumeColonVerbOpt(true)))
)
