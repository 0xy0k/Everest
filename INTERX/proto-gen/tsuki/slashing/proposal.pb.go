...
// source: tsuki/slashing/proposal.proto

package slashing

import (
	fmt "fmt"
	_ "github.com/TsukiCore/tsuki/INTERX/proto-gen/tsuki/gov"
...
func init() {
	proto.RegisterFile("tsuki/slashing/proposal.proto", fileDescriptor_c8be292de7dc6a45)
}
