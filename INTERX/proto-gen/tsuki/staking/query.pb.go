...
func init() {
	proto.RegisterType((*ValidatorsRequest)(nil), "tsuki.staking.ValidatorsRequest")
	proto.RegisterType((*IdentityRecord)(nil), "tsuki.staking.IdentityRecord")
	proto.RegisterMapType((map[string]string)(nil), "tsuki.staking.IdentityRecord.InfosEntry")
	proto.RegisterType((*QueryValidator)(nil), "tsuki.staking.QueryValidator")
	proto.RegisterType((*ValidatorsResponse)(nil), "tsuki.staking.ValidatorsResponse")
}

func init() {
	proto.RegisterFile("tsuki/staking/query.proto", fileDescriptor_a6d324c07c7f430e)
}
