...
tsukid tx customgov set-whitelist-permissions --from validator --keyring-backend=test --permission=3 --addr=$(tsukid keys show -a validator --keyring-backend=test) --chain-id=testing --fees=100stake
...
tsukid tx customgov set-network-properties --from validator --min_tx_fee="2" --max_tx_fee="2000" --keyring-backend=test --chain-id=testing --fees=100stake
