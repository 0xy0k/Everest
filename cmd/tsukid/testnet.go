...
import (
	...
	clientkeys "github.com/TsukiCore/cosmos-sdk/client/keys"
	"github.com/TsukiCore/cosmos-sdk/codec"
	"github.com/TsukiCore/cosmos-sdk/crypto/keyring"
	"github.com/TsukiCore/cosmos-sdk/server"
	srvconfig "github.com/TsukiCore/cosmos-sdk/server/config"
...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "tsukid",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "tsukicli",
...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		tsukiConfigFilePath := filepath.Join(nodeDir, "config/tsukid.toml")
		srvconfig.WriteConfigFile(tsukiConfigFilePath, tsukiConfig)
	}
