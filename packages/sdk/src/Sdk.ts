...
export class Sdk {
  ...
  async getBalancesFor(
    ...
    try {
      ...
      return new EverestResultSuccess(bals);
    } catch (e) {
  ...
  async getBorrowingVaultsFor(
    collateral: Currency,
    debt: Currency
  ): EverestResultPromise<BorrowingVault[]> {
    ...
    try {
      ...
      return new EverestResultSuccess(sorted);
    } catch (error) {
      return new EverestResultError('Error getting vaults', EverestErrorCode.SDK);
    }
  }
