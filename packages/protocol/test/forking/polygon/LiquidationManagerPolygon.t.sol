...
contract LiquidationManagerPolygonForkingTests is ForkingSetup, Routines {
  ...
  function mock_getPriceOf(address currency, address commodity, uint256 priceIn18Decimals) internal {
    vm.mockCall(
      address(oracle),
      abi.encodeWithSelector(IEverestOracle.getPriceOf.selector, currency, commodity, 18),
    ...
    internal
  {
    ...
    vm.mockCall(
      address(oracle),
      abi.encodeWithSelector(IEverestOracle.getPriceOf.selector, currency, commodity, currencyDecimals),
    ...
    vm.mockCall(
      ...
      abi.encodeWithSelector(
        IEverestOracle.getPriceOf.selector, commodity, currency, commodityDecimals
      ),
