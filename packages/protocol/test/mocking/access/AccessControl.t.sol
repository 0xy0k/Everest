...
contract AccessControlUnitTests is MockingSetup {
  EverestOracle public everestOracle;
  ...
  function setUp() public {
    ...
    everestOracle = new EverestOracle(assets, priceFeeds, address(chief));
  }

  /// EverestOracle access control tests
  ...
  function test_tryFoeSetPriceFeed(address foe) public {
    ...
    vm.prank(foe);
    everestOracle.setPriceFeed(address(asset), address(maliciousPriceFeed));
    vm.stopPrank();
  }
