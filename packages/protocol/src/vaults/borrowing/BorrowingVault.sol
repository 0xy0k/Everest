...
contract BorrowingVault is BaseVault {
  ...
  /*
  Factors
  See: https://github.com/Everestcracy/CrossEverest/tree/main/packages/protocol#readme
  */
   ...
   * @param oracle_ address of {EverestOracle} implementation.
   ...
   * Requirements:
   * - Should read price from {EverestOracle}.
   *
