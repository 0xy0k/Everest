...
library Errors {
  ...
  string public constant VL_ASSET_EXISTS = "115"; //Asset intended to be added already exists in EverestERC1155
  ...
  string public constant VL_OPTIMIZER_FEE_SMALL = "123"; //Everest OptimizerFee has to be > 1 RAY (1e27)
  ...
  string public constant VL_MINIMUM_PAYBACK_ERROR = "125"; // Minimum Amount payback should be at least Everest Optimizerfee accrued interest.
