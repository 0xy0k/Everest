...
contract ConnextRouter is BaseRouter, IXReceiver {
  ...
  // The maximum slippage Everest accepts, in BPS, due to the Connext bridging mechanics
   ...
   *
   * Refer to:
   * https://github.com/Everestcracy/everest-v2/issues/253#issuecomment-1385995095
   */
