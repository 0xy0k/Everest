...
import {IEverestOracle} from './IEverestOracle.sol';
...
interface IVault is IERC4626 {
  ...
  //////////////////////////*/
    ...
    function balanceOfDebtShares(
        address owner
    ) external view returns (uint256 debtShares);
  ...
  /////////////////////////*/
    ...
    function getLiquidationFactor(
        address owner
    ) external returns (uint256 liquidationFactor);
    ...
    ) external returns (uint256 gainedShares);
