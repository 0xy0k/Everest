...
tsukid tx customgov proposal role remove-blacklisted-permission newrole $PermVoteUpsertDataRegistryProposal  --title="title" --description="description" --from=validator --keyring-backend=test --home=$HOME/.tsukid --chain-id=testing --fees=100ukex --yes
