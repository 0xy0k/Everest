...
tsukid tx customgov proposal role whitelist-permission newrole $PermCreateUpsertDataRegistryProposal  --title="title" --description="description" --from=validator --keyring-backend=test --home=$HOME/.tsukid --chain-id=testing --fees=100ukex --yes
