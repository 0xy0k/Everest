...
tsukid tx customgov proposal set-network-property UNIQUE_IDENTITY_KEYS moniker,email  --title="title" --description="description" --from=validator --keyring-backend=test --home=$HOME/.tsukid --chain-id=testing --fees=100ukex --yes
